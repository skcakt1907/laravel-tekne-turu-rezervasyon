...
class CollectionResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'tahsilat';

    protected static ?string $pluralModelLabel = 'tahsilat dökümü';

    protected static ?string $navigationLabel = 'Aylık Tahsilat';
